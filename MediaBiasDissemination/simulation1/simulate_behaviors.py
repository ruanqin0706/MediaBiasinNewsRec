...
def parse_args():
    ...
    parser.add_argument("--original_behaviors_path", type=str, default="user_groups.tsv")
    parser.add_argument("--original_news_path", type=str, default="news.tsv")
    parser.add_argument("--nid2bias_path", type=str, default="nid2bias_prob.pkl")
